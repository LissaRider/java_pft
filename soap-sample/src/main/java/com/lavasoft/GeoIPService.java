 ...
 * 2020-10-18T23:17:32.405+03:00
 * Generated source version: 3.4.0
 */
@WebServiceClient(name = "GeoIPService",
        wsdlLocation = "file:/C:/Dev/java_pft/soap-sample/src/main/resources/geoipservice.wsdl",
...
public class GeoIPService extends Service {
  ...
  static {
    URL url = null;
    try {
      url = new URL("file:/C:/Dev/java_pft/soap-sample/src/main/resources/geoipservice.wsdl");
    } catch (MalformedURLException e) {
      java.util.logging.Logger.getLogger(GeoIPService.class.getName())
              .log(java.util.logging.Level.INFO,
                      "Can not initialize the default wsdl from {0}", "file:/C:/Dev/java_pft/soap-sample/src/main/resources/geoipservice.wsdl");
    }
    WSDL_LOCATION = url;
  }
