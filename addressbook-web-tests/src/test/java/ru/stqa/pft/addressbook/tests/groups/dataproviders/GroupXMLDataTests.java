...
public class GroupXMLDataTests extends TestBase {

  @Test(testName = "Проверка создания группы (XML)",
          dataProvider = "groupsFromXmlFile", dataProviderClass = GroupDataProviders.class)
  public void paramTestXmlGroupCreation(GroupData group) {
    app.goTo().groupsPage();
